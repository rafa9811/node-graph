...
/* Devuelve TRUE si los dos nodos pasados como argumento son iguales (revisando todos sus campos). Devuelve FALSE en otro caso. */
Bool node_equals(const Node * n1, const Node * n2);
/* Copia los datos de un nodo a otro devolviendo el nodo copiado (incluyendo la reserva de la memoria necesaria) si todo ha ido bien, o NULL en otro caso */
Node * node_copy(const Node * src);
/* Imprime en pf los datos de un nodo con el siguiente formato:  [id, name]. Por ejemplo, un nodo con nombre “aaa” e id 123 se imprimirá como [123, aaa]. 
Además devolverá el número de caracteres que se han escrito con éxito (mirar documentación de fprintf) */
